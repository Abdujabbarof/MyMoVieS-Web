      ...
      {showSidebar && (
        <Overlay>
          <m.nav
            ...
            ref={ref}
            className={cn(
              `fixed top-0 right-0 sm:w-[300px] w-[260px] h-screen z-[25] shadow-md md:hidden p-4 pb-0 dark:text-gray-200 text-gray-600`,
          ...
          >
            ...
            <div className="sm:pt-8  xs:pt-6 pt-[22px] h-screen flex flex-col">
